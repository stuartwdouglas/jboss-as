...
public class StartupContext {
    ...
    private static final ThreadLocal<ComponentRegistry> COMPONENT_REGISTRY = new ThreadLocal<ComponentRegistry>();

    public static void setComponentRegistry(final ComponentRegistry componentRegistry) {
