...
/**
 * Attribute for the suspend state of a server
 *
 * @author Stuart Douglas
 */
public class SuspendStateHandler implements OperationStepHandler {

    public static final SuspendStateHandler INSTANCE = new SuspendStateHandler();
