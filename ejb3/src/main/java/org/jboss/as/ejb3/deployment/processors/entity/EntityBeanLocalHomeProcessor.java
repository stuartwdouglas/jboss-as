...
/**
 * Processor that hooks up home interfaces for entity beans
 *
 * @author Stuart Douglas
 */
public class EntityBeanLocalHomeProcessor extends AbstractComponentConfigProcessor {
    ...
    protected void processComponentConfig(final DeploymentUnit deploymentUnit, final DeploymentPhaseContext phaseContext, final CompositeIndex index, final ComponentDescription componentDescription) throws DeploymentUnitProcessingException {
        ...
        if (componentDescription instanceof EntityBeanComponentDescription) {
            final EntityBeanComponentDescription ejbComponentDescription = (EntityBeanComponentDescription) componentDescription;
