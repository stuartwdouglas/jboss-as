...
public class EJB3RemoteHTTPService implements Service<EJB3RemoteHTTPService> {
    ...
    public void start(StartContext context) throws StartException {
        EjbHttpService service = new EjbHttpService(associationServiceInjectedValue.getValue().getAssociation(), executorServiceInjectedValue.getOptionalValue(), localTransactionContextInjectedValue.getValue());
