            ...
            if (timerService != null) {
                for (TimerServiceMetaData data : timerService) {
                    if (data.getEjbName().equals("*")) {
                        defaultTimerPersistenceService = TimerPersistence.SERVICE_NAME.append(data.getCacheName());
                    } else {
                        timerPersistenceServices.put(data.getEjbName(), TimerPersistence.SERVICE_NAME.append(data.getCacheName()));
                    }
                }
            }
        }
