...
public class FileDataStoreResourceDefinition extends SimpleResourceDefinition {
    ...
    public static final FileDataStoreResourceDefinition INSTANCE = new FileDataStoreResourceDefinition();
    ...
    private FileDataStoreResourceDefinition() {
        super(EJB3SubsystemModel.FILE_DATA_STORE_PATH,
                ...
                FileDataStoreAdd.INSTANCE, ReloadRequiredRemoveStepHandler.INSTANCE,
