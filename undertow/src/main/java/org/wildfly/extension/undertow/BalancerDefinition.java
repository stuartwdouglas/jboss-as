 ...
 */
public class BalancerDefinition extends SimpleResourceDefinition {

    private final boolean registerRuntimeOnly;

    public BalancerDefinition(final ModClusterRuntimeResource resource, final boolean registerRuntimeOnly) {
        super(ModClustere,
