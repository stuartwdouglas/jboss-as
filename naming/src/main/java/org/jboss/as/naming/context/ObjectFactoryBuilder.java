...
public class ObjectFactoryBuilder implements javax.naming.spi.ObjectFactoryBuilder, DirObjectFactory {
    ...
    private static ObjectFactory processURL(Object refInfo, Hashtable environment)
            throws NamingException {
        ...
        if (refInfo instanceof String) {
            ...
            if (scheme != null) {
                answer = getURLObjectFactory(scheme, url, environment);
                if (answer != null) {
                    return answer;
                }
            }
        ...
        if (refInfo instanceof String[]) {
            ...
            for (int i = 0; i < urls.length; i++) {
                ...
                if (scheme != null) {
                    answer = getURLObjectFactory(scheme,urls[i], environment);
                    if (answer != null) {
                        return answer;
                    }
                }
