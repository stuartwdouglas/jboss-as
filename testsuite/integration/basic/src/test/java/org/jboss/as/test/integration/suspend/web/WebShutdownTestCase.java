...
public class WebShutdownTestCase {

    protected static Logger log = Logger.getLogger(WebShutdownTestCase.class);
    ...
    public static WebArchive deployment() {
        ...
        war.addPackage(WebShutdownTestCase.class.getPackage());
