 ...
 */
package org.jboss.as.testsuite.integration.ejb.entity.cmp.relationship.oneToOneBidirectional;
...
public class ABTestCase {
    ...
    private AHome getTableAHome() {
        try {
            return (AHome)iniCtx.lookup("java:module/A_OneToOne_Bi_Table_EJB!org.jboss.as.testsuite.integration.ejb.entity.cmp.relationship.oneToOneBidirectional.AHome");
        } catch (Exception e) {
            log.debug("failed", e);
    ...
    private BHome getTableBHome() {
        try {
            return (BHome)iniCtx.lookup("java:module/B_OneToOne_Bi_Table_EJB!org.jboss.as.testsuite.integration.ejb.entity.cmp.relationship.oneToOneBidirectional.BHome");
        } catch (Exception e) {
            log.debug("failed", e);
    ...
    private AHome getFKAHome() {
        try {
            return (AHome)iniCtx.lookup("java:module/A_OneToOne_Bi_FK_EJB!org.jboss.as.testsuite.integration.ejb.entity.cmp.relationship.oneToOneBidirectional.AHome");
        } catch (Exception e) {
            log.debug("failed", e);
    ...
    private BHome getFKBHome() {
        try {
            return (BHome)iniCtx.lookup("java:module/B_OneToOne_Bi_FK_EJB!org.jboss.as.testsuite.integration.ejb.entity.cmp.relationship.oneToOneBidirectional.BHome");
        } catch (Exception e) {
            log.debug("failed", e);
