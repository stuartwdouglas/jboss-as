 ...
 */
package org.jboss.as.testsuite.integration.ejb.entity.cmp.relationship.oneToManyBidirectional;
...
public class ABTestCase {
    ...
    private AHome getTableAHome() {
        try {
            return (AHome) iniCtx.lookup("java:module/A_OneToMany_Bi_Table_EJB!org.jboss.as.testsuite.integration.ejb.entity.cmp.relationship.oneToManyBidirectional.AHome");
        } catch (Exception e) {
            log.debug("failed", e);
    ...
    private BHome getTableBHome() {
        try {
            return (BHome) iniCtx.lookup("java:module/B_OneToMany_Bi_Table_EJB!org.jboss.as.testsuite.integration.ejb.entity.cmp.relationship.oneToManyBidirectional.BHome");
        } catch (Exception e) {
            log.debug("failed", e);
    ...
    private AHome getFKAHome() {
        try {
            return (AHome) iniCtx.lookup("java:module/A_OneToMany_Bi_FK_EJB!org.jboss.as.testsuite.integration.ejb.entity.cmp.relationship.oneToManyBidirectional.AHome");
        } catch (Exception e) {
            log.debug("failed", e);
    ...
    private BHome getFKBHome() {
        try {
            return (BHome) iniCtx.lookup("java:module/B_OneToMany_Bi_FK_EJB!org.jboss.as.testsuite.integration.ejb.entity.cmp.relationship.oneToManyBidirectional.BHome");
        } catch (Exception e) {
            log.debug("failed", e);
