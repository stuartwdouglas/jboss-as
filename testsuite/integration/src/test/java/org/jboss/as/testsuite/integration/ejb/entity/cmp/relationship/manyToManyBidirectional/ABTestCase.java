 ...
 */
package org.jboss.as.testsuite.integration.ejb.entity.cmp.relationship.manyToManyBidirectional;
...
public class ABTestCase {
    ...
    private AHome getAHome() {
        try {
            return (AHome) iniCtx.lookup("java:module/A_ManyToMany_Bi_EJB!org.jboss.as.testsuite.integration.ejb.entity.cmp.relationship.manyToManyBidirectional.AHome");
        } catch (Exception e) {
            log.debug("failed", e);
    ...
    private BHome getBHome() {
        try {
            return (BHome) iniCtx.lookup("java:module/B_ManyToMany_Bi_EJB!org.jboss.as.testsuite.integration.ejb.entity.cmp.relationship.manyToManyBidirectional.BHome");
        } catch (Exception e) {
            log.debug("failed", e);
