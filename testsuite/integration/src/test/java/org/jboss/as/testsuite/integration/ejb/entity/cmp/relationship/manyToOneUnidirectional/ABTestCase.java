 ...
 */
package org.jboss.as.testsuite.integration.ejb.entity.cmp.relationship.manyToOneUnidirectional;
...
public class ABTestCase {
    ...
    private AHome getTableAHome() {
        try {
            return (AHome) iniCtx.lookup("java:module/A_ManyToOne_Uni_Table_EJB!org.jboss.as.testsuite.integration.ejb.entity.cmp.relationship.manyToOneUnidirectional.AHome");
        } catch (Exception e) {
            log.debug("failed", e);
    ...
    private BHome getTableBHome() {
        try {
            return (BHome) iniCtx.lookup("java:module/B_ManyToOne_Uni_Table_EJB!org.jboss.as.testsuite.integration.ejb.entity.cmp.relationship.manyToOneUnidirectional.BHome");
        } catch (Exception e) {
            log.debug("failed", e);
    ...
    private AHome getFKAHome() {
        try {
            return (AHome) iniCtx.lookup("java:module/A_ManyToOne_Uni_FK_EJB!org.jboss.as.testsuite.integration.ejb.entity.cmp.relationship.manyToOneUnidirectional.AHome");
        } catch (Exception e) {
            log.debug("failed", e);
    ...
    private BHome getFKBHome() {
        try {
            return (BHome) iniCtx.lookup("java:module/B_ManyToOne_Uni_FK_EJB!org.jboss.as.testsuite.integration.ejb.entity.cmp.relationship.manyToOneUnidirectional.BHome");
        } catch (Exception e) {
            log.debug("failed", e);
