...
public final class JDBCCMRFieldBridge extends JDBCAbstractCMRFieldBridge {
    ...
    public void cascadeDelete(CmpEntityBeanContext ctx, List oldValues)
    ...
    public Class getRelatedLocalInterface() {
        return getRelatedComponent().getComponentClass();
    }
    ...
    public EJBLocalObject getRelatedEntityByFK(Object fk) {
        ...
        if (hasFKFieldsMappedToCMPFields
            ...
            relatedLocalObject = relatedContainer.getEntityEJBLocalObject(fk);
        }
    ...
    public boolean isForeignKeyValid(Object fk) {
        ...
        if (relatedManager.getReadAheadCache().getPreloadDataMap(fk, false) != null) {
            ...
            EJBLocalHome relatedHome = getRelatedComponent().getEJBLocalHome();
            try {
    ...
    public void createRelationLinks(CmpEntityBeanContext myCtx, Object relatedId, boolean updateForeignKey) {
        ...
        relatedCMRField.invokeAddRelation(tx, relatedId, myCtx.getPrimaryKey());
    }
    ...
    public void destroyRelationLinks(CmpEntityBeanContext myCtx,
        ...
        relatedCMRField.invokeRemoveRelation(getTransaction(), relatedId, myCtx.getPrimaryKey());
    }
    ...
    private Object invokeScheduleForCascadeDelete(Transaction tx, Object myId) {
        try {
            ReadyEntityCache instanceCache = manager.getComponent().getCache();
            ...
            return manager.getComponent().invoke(invocation);
        } catch (EJBException e) {
            throw e;
        } catch (Exception e) {
    ...
    private void invokeAddRelation(Transaction tx, Object myId, Object relatedId) {
        try {
            ...
            invocation.setCredential(sc.getUtil().getCredential());
            invocation.setType(InvocationType.LOCAL);
            manager.getComponent().invoke(invocation);
        } catch (EJBException e) {
            throw e;
        } catch (Exception e) {
