...
public class CmpEntityBeanSynchronizationInterceptor extends EntityBeanSynchronizationInterceptor {
    ...
    public CmpEntityBeanSynchronizationInterceptor(boolean reentrant) {
        super(reentrant);
    }
    ...
    public Object processInvocation(final InterceptorContext context) throws Exception {
        ...
        final CmpEntityBeanContext entityContext = (CmpEntityBeanContext) instance.getEntityContext();
