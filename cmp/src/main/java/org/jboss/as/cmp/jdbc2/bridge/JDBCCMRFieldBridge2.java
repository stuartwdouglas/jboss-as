...
import org.jboss.as.cmp.jdbc.bridge.Entrancy;
    ...
    public class SingleValuedFieldState
        ...
        public Object getValue(CmpEntityBeanContext ctx) {
            ...
            if (value == null) {
                ...
                localObject = relatedComponent.getEntityEJBLocalObject(value);
            }
            return localObject;
        }
        ...
        public void setValue(CmpEntityBeanContext ctx, Object value) {
            if (value != null) {
                ...
                relatedCMRField.invokeAddRelatedId(relatedId, ctx.getPrimaryKey());
        ...
        public void destroyExistingRelationships(CmpEntityBeanContext ctx) {
            ...
            if (value != null) {
                ...
                relatedCMRField.invokeRemoveRelatedId(value, ctx.getPrimaryKey());
            }
        }
        ...
        public void destroyExistingRelationships(CmpEntityBeanContext ctx) {
            ...
            if (!value.isEmpty()) {
                ...
                for (int i = 0; i < copy.length; ++i) {
                    ...
                    relatedCMRField.invokeRemoveRelatedId(relatedId, ctx.getPrimaryKey());
                    loader.removeRelatedId(ctx, relatedId);
                }
            }
        }
    ...
    private class CMRSet
        ...
        public Iterator iterator() {
            return new Iterator() {
                ...
                public Object next() {
                    ...
                    return relatedComponent.getEntityEJBLocalObject(curId);
                }
            };
        }
        ...
        public Object[] toArray() {
            ...
            for (Iterator iter = value.iterator(); iter.hasNext(); ) {
                Object id = iter.next();
                result[i++] = relatedComponent.getEntityEJBLocalObject(id);
            }
        ...
        public Object[] toArray(Object[] a) {
            ...
            for (Iterator iter = value.iterator(); iter.hasNext(); ) {
                Object id = iter.next();
                a[i++] = relatedComponent.getEntityEJBLocalObject(id);
            }
