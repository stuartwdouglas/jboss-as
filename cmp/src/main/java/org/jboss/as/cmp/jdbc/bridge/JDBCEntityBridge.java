...
public class JDBCEntityBridge implements JDBCAbstractEntityBridge {
    ...
    public void init() throws Exception {
        ...
        if (lockMetaData != null && lockMetaData.getLockingField() != null) {
            ...
            if (strategy == JDBCOptimisticLockingMetaData.LockingStrategy.VERSION_COLUMN_STRATEGY) {
                if (hidden)
            ...
            } else if (strategy == JDBCOptimisticLockingMetaData.LockingStrategy.TIMESTAMP_COLUMN_STRATEGY) {
                if (hidden)
            ...
            } else if (strategy == JDBCOptimisticLockingMetaData.LockingStrategy.KEYGENERATOR_COLUMN_STRATEGY) {
                // TODO: jeb - Create a KeyGenerator based version field bridge
            }
