    ...
    public void getResourceValue(final ResolutionContext context, final ServiceBuilder<?> serviceBuilder, final DeploymentPhaseContext phaseContext, final Injector<ManagedReferenceFactory> injector) throws DeploymentUnitProcessingException {
        ...
        try {
            ...
            if (XADataSource.class.isAssignableFrom(clazz)) {
                final CommonXaPoolImpl xaPool = new CommonXaPoolImpl(minPoolSize == -1 ? Defaults.MIN_POOL_SIZE : minPoolSize, maxPoolSize == -1 ? Defaults.MAX_POOL_SIZE : maxPoolSize,
                ...
                final CommonPoolImpl commonPool = new CommonPoolImpl(minPoolSize, maxPoolSize, Defaults.PREFILL, Defaults.USE_STRICT_MIN, Defaults.FLUSH_STRATEGY);
                final ModifiableDataSource dataSource = new ModifiableDataSource(url, null, className, null, transactionIsolation(), props,
                        null, dsSecurity, null, null, ";", null, null, false, poolName, true, jndiName, Defaults.SPY, Defaults.USE_CCM, transactional, commonPool);
