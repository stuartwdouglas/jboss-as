...
package org.jboss.as.iiop.naming.jndi;
...
import org.jboss.as.iiop.service.CurrentORB;
...
public class CNCtx implements javax.naming.Context {
    ...
    static final org.jboss.as.iiop.naming.jndi.CNNameParser parser = new org.jboss.as.iiop.naming.jndi.CNNameParser();
    ...
    CNCtx(ORB orb, NamingContext nctx, Hashtable env, NameComponent[] name) throws NamingException {
        if (orb == null || nctx == null)
            throw IIOPMessages.MESSAGES.errorConstructingCNCtx();
        _orb = orb;
        _nc = nctx;
        _env = env;
        _name = name;
    ...
    public String getNameInNamespace() throws NamingException {
        ...
        return org.jboss.as.iiop.naming.jndi.CNNameParser.cosNameToInsString(_name);
    }
        ...
        if (provUrl != null && !isCorbaUrl(provUrl)) {
            ...
            if (insName.length() > 0) {
                ...
                try {
                    ...
                    if (_nc == null) {
                        throw IIOPMessages.MESSAGES.notANamingContext(insName);
                    }
                } catch (org.omg.CORBA.BAD_PARAM e) {
                    throw IIOPMessages.MESSAGES.notANamingContext(insName);
                } catch (Exception e) {
                    throw org.jboss.as.iiop.naming.jndi.ExceptionMapper.mapException(e, this, _name);
                }
            }
        } else {
    ...
    private String initUsingIiopUrl(ORB defOrb, String url, Hashtable env)
        ...
        try {
            ...
            if (savedException != null) {
                ...
                throw IIOPMessages.MESSAGES.invalidURLOrIOR(url);
            }
    ...
    private String initUsingCorbanameUrl(ORB orb, String url, Hashtable env)
            throws NamingException {
        try {
            org.jboss.as.iiop.naming.jndi.CorbanameUrl parsedUrl = new org.jboss.as.iiop.naming.jndi.CorbanameUrl(url);
        ...
        try {
            ...
            if (_nc == null) {
                if (ncIor != null) {
                    ...
                    throw IIOPMessages.MESSAGES.errorResolvingNSInitRef();
                }
            }
        } catch (org.omg.CORBA.ORBPackage.InvalidName in) {
            NamingException ne = IIOPMessages.MESSAGES.cosNamingNotRegisteredCorrectly();
            ne.setRootCause(in);
            throw ne;
        } catch (org.omg.CORBA.COMM_FAILURE e) {
            NamingException ne = IIOPMessages.MESSAGES.errorConnectingToORB();
            ne.setRootCause(e);
            throw ne;
        } catch (org.omg.CORBA.BAD_PARAM e) {
            NamingException ne = IIOPMessages.MESSAGES.invalidURLOrIOR(ncIor);
            ne.setRootCause(e);
            throw ne;
        } catch (org.omg.CORBA.INV_OBJREF e) {
            NamingException ne = IIOPMessages.MESSAGES.invalidObjectReference(ncIor);
            ne.setRootCause(e);
            throw ne;
        }
    }
    ...
    private void setOrbAndRootContext(ORB orb, org.omg.CORBA.Object ncRef)
        ...
        try {
            _nc = NamingContextHelper.narrow(ncRef);
            if (_nc == null) {
                throw IIOPMessages.MESSAGES.errorConvertingIORToNamingCtx(ncRef.toString());
            }
        } catch (org.omg.CORBA.COMM_FAILURE e) {
             NamingException ne = IIOPMessages.MESSAGES.errorConnectingToORB();
            ne.setRootCause(e);
    ...
    private String getStringifiedIor(String url) throws NamingException {
        if (url.startsWith("IOR:") || url.startsWith("corbaloc:")) {
            ...
            try {
                ...
                NamingException ne = IIOPMessages.MESSAGES.invalidURLOrIOR(url);
                ne.setRootCause(e);
                throw ne;
            } finally {
                try {
            ...
            throw IIOPMessages.MESSAGES.urlDoesNotContainIOR(url);
        }
    }
    ...
    java.lang.Object callResolve(NameComponent[] path)
        ...
        try {
            ...
            throw org.jboss.as.iiop.naming.jndi.ExceptionMapper.mapException(e, this, path);
        }
    }
    ...
    public java.lang.Object lookup(Name name)
            throws NamingException {
        if (_nc == null)
            throw IIOPMessages.MESSAGES.notANamingContext(name.toString());
        if (name.size() == 0)
            return this; // %%% should clone() so that env can be changed
        NameComponent[] path = org.jboss.as.iiop.naming.jndi.CNNameParser.nameToCosName(name);
    ...
    private void callBindOrRebind(NameComponent[] pth, Name name,
        ...
        try {
            ...
            if (obj instanceof org.omg.CosNaming.NamingContext) {
                ...
                throw IIOPMessages.MESSAGES.notACorbaObject();
        } catch (BAD_PARAM e) {
            ...
            throw org.jboss.as.iiop.naming.jndi.ExceptionMapper.mapException(e, this, pth);
        }
    }
        ...
        try {
            ...
            if (resObj instanceof Reference) {
                ...
                if (addr.getContent() instanceof javax.naming.Context) {
                    NamingException ne = IIOPMessages.MESSAGES.noReferenceFound();
    ...
    private void callUnbind(NameComponent[] path) throws NamingException {
        if (_nc == null)
            throw IIOPMessages.MESSAGES.notANamingContext(path.toString());
        try {
            _nc.unbind(path);
        } catch (NotFound e) {
    ...
    public void rename(Name oldName, Name newName)
            throws NamingException {
        if (_nc == null)
            throw IIOPMessages.MESSAGES.notANamingContext(oldName.toString());
    ...
    public NamingEnumeration listBindings(Name name)
        ...
        if (name.size() > 0) {
            try {
                ...
                if (obj instanceof CNCtx) {
                    return new org.jboss.as.iiop.naming.jndi.CNBindingEnumeration(
                            (CNCtx) obj, true, _env);
                } else {
        ...
        return new org.jboss.as.iiop.naming.jndi.CNBindingEnumeration(this, false, _env);
    }
    ...
    private void callDestroy(NamingContext nc)
            throws NamingException {
        if (_nc == null)
            throw IIOPMessages.MESSAGES.notANamingContext(nc.toString());
        try {
            nc.destroy();
        } catch (Exception e) {
            throw org.jboss.as.iiop.naming.jndi.ExceptionMapper.mapException(e, this, null);
        }
    }
