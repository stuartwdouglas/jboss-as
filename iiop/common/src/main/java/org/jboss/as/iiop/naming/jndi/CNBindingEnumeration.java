...
final class CNBindingEnumeration implements NamingEnumeration {
    ...
    private javax.naming.Binding mapBinding(org.omg.CosNaming.Binding bndg)
        ...
        Name cname = org.jboss.as.iiop.naming.jndi.CNNameParser.cosNameToName(bndg.binding_name);
        ...
        String fullName = org.jboss.as.iiop.naming.jndi.CNNameParser.cosNameToInsString(comps);
