...
import org.jboss.as.jacorb.service.JacORBCorbaNamingService;
import org.jboss.as.jacorb.service.JacORBCorbaORBService;
    ...
    protected void performRuntime(OperationContext context, ModelNode operation, ModelNode model,
        ...
        context.addStep(new AbstractDeploymentChainStep() {
            public void execute(DeploymentProcessorTarget processorTarget) {
                ...
                processorTarget.addDeploymentProcessor(JacORBExtension.SUBSYSTEM_NAME, Phase.PARSE, Phase.PARSE_JACORB, new IIOPMarkerProcessor());
            }
        ...
        JacORBCorbaORBService orbService = new JacORBCorbaORBService(props);
        ...
        final JacORBCorbaNamingService namingServiceJacORB = new JacORBCorbaNamingService();
        newControllers.add(context.getServiceTarget().addService(IIOPServiceNames.NAMING_SERVICE_NAME, namingServiceJacORB).
                addDependency(IIOPServiceNames.ORB_SERVICE_NAME, ORB.class, namingServiceJacORB.getORBInjector()).
                addDependency(IIOPServiceNames.ROOT_SERVICE_NAME, POA.class,
                        namingServiceJacORB.getRootPOAInjector()).
                addDependency(IIOPServiceNames.POA_SERVICE_NAME.append("namingpoa"), POA.class,
                        namingServiceJacORB.getNamingPOAInjector()).
                addListener(verificationHandler).
                setInitialMode(ServiceController.Mode.ACTIVE).install());
    }
