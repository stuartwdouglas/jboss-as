...
import org.jboss.as.sunorb.SunORBMessages;
...
class Util {
    ...
    static SSLContext forDomain(JSSESecurityDomain securityDomain) throws IOException {
        ...
        try {
            ...
            if (keyManagers == null)
                throw SunORBMessages.MESSAGES.errorObtainingKeyManagers(securityDomain.getSecurityDomain());
            TrustManager[] trustManagers = securityDomain.getTrustManagers();
            sslCtx.init(keyManagers, trustManagers, null);
            return sslCtx;
        } catch (NoSuchAlgorithmException e) {
            throw SunORBMessages.MESSAGES.failedToGetSSLContext(e);
