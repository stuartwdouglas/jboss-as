...
package org.jboss.as.sunorb.security;
 ...
 */
public class SunSocketFactory extends DefaultSocketFactoryImpl implements Service<SunSocketFactory> {
    ...
    public SunSocketFactory(final boolean request_mutual_auth, final boolean require_mutual_auth) {
    ...
    @Override
    public SunSocketFactory getValue() throws IllegalStateException, IllegalArgumentException {
        return this;
    }
}
