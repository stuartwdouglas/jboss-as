...
public interface SunORBLogger extends BasicLogger {

    SunORBLogger ROOT_LOGGER = Logger.getMessageLogger(SunORBLogger.class, SunORBLogger.class.getPackage().getName());
