...
import org.jboss.as.sunorb.SunORBLogger;
import org.jboss.as.sunorb.SunORBSubsystemConstants;
 ...
 */
public class SunCorbaORBService implements Service<ORB>, OrbService {
     ...
     */
    public SunCorbaORBService(Properties props) {
    ...
    public void start(StartContext context) throws StartException {
        ...
        SunORBLogger.ROOT_LOGGER.debugServiceStartup(context.getController().getName().getCanonicalName());

        try {
            // set the ORBClass and ORBSingleton class as system properties.
            properties.setProperty(SunORBSubsystemConstants.ORB_CLASS, ORBImpl.class.getName());
            properties.setProperty(SunORBSubsystemConstants.ORB_SINGLETON_CLASS, ORBSingleton.class.getName());
            SecurityActions.setSystemProperty(SunORBSubsystemConstants.ORB_CLASS, ORBImpl.class.getName());
            SecurityActions.setSystemProperty(SunORBSubsystemConstants.ORB_SINGLETON_CLASS, ORBSingleton.class.getName());
        ...
        SunORBLogger.ROOT_LOGGER.corbaORBServiceStarted();
        this.properties = properties;
    }

    @Override
    public void stop(StopContext context) {
        SunORBLogger.ROOT_LOGGER.debugServiceStop(context.getController().getName().getCanonicalName());
    ...
    public boolean interopIONA() {
        return "on".equalsIgnoreCase(getORBProperty(SunORBSubsystemConstants.INTEROP_IONA));
    }
